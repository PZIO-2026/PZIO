...
interface Props {
  ...
  // Earliest selectable endDate (yyyy-mm-dd). When set, the native picker
  // disables earlier dates. Used in both create and edit flows to prevent
  // selecting an end date in the past or before the start date.
  minEndDate?: string;
}
